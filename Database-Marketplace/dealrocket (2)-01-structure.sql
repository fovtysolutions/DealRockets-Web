...
CREATE TABLE `products` (
  ...
  `sample_price` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `sample_amount` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `fob_port` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `weight_per_unit` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `hts_code` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `export_carton_dimensions` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logistics_attributes` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `lead_time` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `dimensions_per_unit` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `units_per_carton` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `carton_weight` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `export_markets` text COLLATE utf8mb4_unicode_ci,
  `payment_methods` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `currency_accepted` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `payment_terms` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `invoicing` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
ALTER TABLE `error_logs`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1172;
...
ALTER TABLE `guest_users`
  MODIFY `id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4833;

...
class NewProductStoreController extends Controller
{
    ...
    protected function validateProduct(Request $request): array
    {
        return $request->validate([
            ...
            'thumbnail' => 'nullable|file|mimes:pdf,jpg,jpeg,png,webp,avif|max:2048',
            'extra_images' => 'array|max:8',
            'extra_images.*' => 'file|mimes:pdf,jpg,jpeg,png,webp,avif|max:2048',
            'certificates' => 'array|max:8',
            'certificates.*' => 'file|mimes:pdf,jpg,jpeg,png,webp,avif|max:2048',

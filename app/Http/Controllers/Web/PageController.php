...
class PageController extends Controller
{
    ...
    public function getAboutUsView(): View
    {
        ...
        return view(VIEW_FILE_NAMES['about_us'], compact('categories','aboutUs', 'pageTitleBanner', 'robotsMetaContentData'));
    }
    ...
    public function getContactView(): View
    {
        ...
        return view(VIEW_FILE_NAMES['contacts'], compact('categories','recaptcha', 'robotsMetaContentData'));
    }
    ...
    public function getRefundPolicyView(): View|RedirectResponse
    {
        ...
        return view(VIEW_FILE_NAMES['refund_policy_page'], compact('categories','refundPolicy', 'pageTitleBanner', 'robotsMetaContentData'));
    }
    ...
    public function getReturnPolicyView(): View|RedirectResponse
    {
        ...
        return view(VIEW_FILE_NAMES['return_policy_page'], compact('categories','returnPolicy', 'pageTitleBanner', 'robotsMetaContentData'));
    }
    ...
    public function getPrivacyPolicyView(): View
    {
        ...
        return view(VIEW_FILE_NAMES['privacy_policy_page'], compact('categories','privacyPolicy', 'pageTitleBanner', 'robotsMetaContentData'));
    }
    ...
    public function getCancellationPolicyView(): View|RedirectResponse
    {
        ...
        return view(VIEW_FILE_NAMES['cancellation_policy_page'], compact('categories','cancellationPolicy', 'pageTitleBanner', 'robotsMetaContentData'));
    }
    ...
    public function getShippingPolicyView(): View|RedirectResponse
    {
        ...
        return view(VIEW_FILE_NAMES['shipping_policy_page'], compact('categories','shippingPolicy', 'pageTitleBanner', 'robotsMetaContentData'));
    }
    ...
    public function getTermsAndConditionView(): View
    {
        ...
        return view(VIEW_FILE_NAMES['terms_conditions_page'], compact('categories','termsCondition', 'pageTitleBanner', 'robotsMetaContentData'));
    }

        ...
        if (!App::runningInConsole()) {
            ...
            try {
                if (Schema::hasTable('business_settings')) {
                    ...
                    $settingsu = Helpers::get_settings($web, 'colorsu');
                    $datau = $settingsu ? json_decode($settingsu['value'], true) : [
                        'textcolor' => '#000000', // Default text color
                        'hovercolor' => '#007BFF' // Default hover color
                    ];

                    $settingsp = Helpers::get_settings($web, 'colorsp');
                    $datap = $settingsp ? json_decode($settingsp['value'], true) : [
                        'bgcolor' => '#000000',
                    ];

                    $settingsl = Helpers::get_settings($web, 'headercolors');
                    $datal = $settingsl ? json_decode($settingsl['value'], true) : [
                        'first_header_color' => '#FFFFF', // Default text color
                        'second_header_color' => '#FFFFFF' // Default hover color
                    ];
                    ...
                    $web_config = [
                        ...
                        'first_header_color' => $datal['first_header_color'],
                        'second_header_color' => $datal['second_header_color'],

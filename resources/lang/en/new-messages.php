...
return [
	...
	"top_sellersssss" => "Top sellersssss",
	...
	"supplier" => "Supplier",
	"suppliers" => "Suppliers",
	"trade_show_management" => "Trade show management",
	"trade_Show" => "Trade Show",
	"Trades_List" => "Trades List",
	"add_New_Trades" => "Add New Trades",
	"website_banner_logo" => "Website banner logo",
	"website_box_logo_1" => "Website box logo 1",
	"website_box_logo_2" => "Website box logo 2",
	"website_box_logo_3" => "Website box logo 3",
	"website_box_logo_4" => "Website box logo 4",
	"Add Job Vacancy" => "Add Job Vacancy",
	...
	"cv" => "Cv",
	"CV_List" => "CV List",
	"Job Vacancies List" => "Job Vacancies List",
	"Job Vacancy List" => "Job Vacancy List",
	"Add Job Vacancies" => "Add Job Vacancies",
	"Jobs_management" => "Jobs management",
	"List Job Profiles" => "List Job Profiles",
	"membership" => "Membership",
	"years" => "Years",
	"sales_commission" => "Sales commission",
	...
	"Open to Remote" => "Open to Remote",
	"Available Immediately" => "Available Immediately",
	"Availability Date" => "Availability Date",
	"References" => "References",
	"Hobbies" => "Hobbies",
	"Has Driver's License" => "Has Driver s License",
	...
	"table job profiles" => "Table job profiles",
	...
	"Experience Required (in years)" => "Experience Required (in years)",
	...
	"Applications Sent" => "Applications Sent",
	"Connections" => "Connections",
	"View Current Resume" => "View Current Resume",
	"if_enabled,_you_can_choose_one_or_multiple_countries_for_product_delivery" => "If enabled  you can choose one or multiple countries for product delivery",
	"if_enabled,_the_zip_code_areas_will_be_available_for_delivery" => "If enabled  the zip code areas will be available for delivery",
	"If_you_don’t_enter_a_specific_zip_code_from_a_country,_that_area_won’t_be_available_for_delivery" => "If you don’t enter a specific zip code from a country  that area won’t be available for delivery",
	"if_both_features_are_disabled,_then_all_places_will_be_available_as_delivery_area" => "If both features are disabled  then all places will be available as delivery area",
	...
	"search_by_leads_Name" => "Search by leads Name",
	"leads Name" => "Leads Name",
	"posted_date" => "Posted date",
	"no_leads_found" => "No leads found",
	"Leads_Add" => "Leads Add",
	"buyer_or_seller" => "Buyer or seller",
	"select_buyer_or_seller" => "Select buyer or seller",
	"buyer" => "Buyer",
	"Lead_name" => "Lead name",
	"new_lead" => "New lead",
	"type_country_name" => "Type country name",
	"quantity_required" => "Quantity required",
	"enter_quantity_required" => "Enter quantity required",
	"buying_frequency" => "Buying frequency",
	"select_buying_frequency" => "Select buying frequency",
	"daily" => "Daily",
	"weekly" => "Weekly",
	"monthly" => "Monthly",
	"quaterly" => "Quaterly",
	...
	"Sorry_no_data_found_related_to_your_search" => "Sorry no data found related to your search",
	"Search for job profiles" => "Search for job profiles",
	...
	"all_main_products" => "All main products",
	"management_certification" => "Management certification",
	"all_management_certification" => "All management certification",
	"city_province" => "City province",
	"all_city_province" => "All city province",
	...
	"web_stuff_Setting" => "Web stuff Setting",
	...
	"business_type" => "Business type",
	"enter_main_products" => "Enter main products",
	"enter_management_certification" => "Enter management certification",
	...
	"Beauty" => "Beauty",
	"supplier_Bulk_Import" => "Supplier Bulk Import",
	"Edit_Supplier" => "Edit Supplier",
	"Update_Supplier" => "Update Supplier",
	"Edit_Leads" => "Edit Leads",
	"Update_Leads" => "Update Leads",
	"select_type" => "Select type",
	"leads_name" => "Leads name",
	"new_leads" => "New leads",
	"View_Lead" => "View Lead",
	...
	"Buying Freqency" => "Buying Freqency",
	"Back to List" => "Back to List",
	"Tradeshow List" => "Tradeshow List",
	"Filter Tradeshows" => "Filter Tradeshows",
	"All Companys" => "All Companys",
	"All Countries" => "All Countries",
	"Enter Contact Number" => "Enter Contact Number",
	"Show Data" => "Show Data",
	"Search by Tradeshow Name" => "Search by Tradeshow Name",
	"Add New Tradeshow" => "Add New Tradeshow",
	"Tradeshow Name" => "Tradeshow Name",
	"Import Bulk Tradeshow" => "Import Bulk Tradeshow",
	"Enter Name" => "Enter Name",
	"Enter Company Name" => "Enter Company Name",
	"Hall" => "Hall",
	"Enter Hall" => "Enter Hall",
	"Stand" => "Stand",
	"Enter Stand" => "Enter Stand",
	"Enter Description" => "Enter Description",
	"Enter Website URL" => "Enter Website URL",
	"Images" => "Images",
	"Edit Tradeshow" => "Edit Tradeshow",
	"Update Tradeshow" => "Update Tradeshow",
	"View Tradeshow" => "View Tradeshow",
	"Tradeshow Details" => "Tradeshow Details",
	"quotations_List" => "Quotations List",
	"filter_quotations" => "Filter quotations",
	"search_by_quantity" => "Search by quantity",
	...
	"enter_pnumber" => "Enter pnumber",
	"quotation_Bulk_Import" => "Quotation Bulk Import",
	...
	"Update Vacancy" => "Update Vacancy",
	"Show_Vacancies" => "Show Vacancies",
	"Show Vacancy Details" => "Show Vacancy Details",
	...
	"enter_buying_frequency" => "Enter buying frequency",
	"no_coupon_found" => "No coupon found",
	...
	"Leads_Messages" => "Leads Messages",
	"Tradeshow_Bulk_Import" => "Tradeshow Bulk Import",
	"cv_List" => "Cv List",
	"filter_cvs" => "Filter cvs",
	"search_by_details" => "Search by details",
	"search_by_phone_number" => "Search by phone number",
	"Stock_List" => "Stock List",
	"Create_Stock" => "Create Stock",
	"Stock_Sell_Messages" => "Stock Sell Messages",
	"Stock_Sale_Messages" => "Stock Sale Messages",
	"Edit_Stock" => "Edit Stock",
	"Trending_Setting" => "Trending Setting",
	"Top_Suppliers" => "Top Suppliers",
	"Tradeshow" => "Tradeshow",
	"Trending Products Setting" => "Trending Products Setting",
	"Top Supplier Setting" => "Top Supplier Setting",
	"Buyer Setting" => "Buyer Setting",
	"Seller Setting" => "Seller Setting",
	"Trade Show Setting" => "Trade Show Setting",
	"bg_color" => "Bg color",
	"Top categories" => "Top categories",
	"chats others" => "Chats others",
	"cvs" => "Cvs",
	"memberships" => "Memberships",
	"shortlist candidates" => "Shortlist candidates",
	"stock sell" => "Stock sell",
	"web_membership_Setting" => "Web membership Setting",
	"web_banner_Setting" => "Web banner Setting",
	"Background_Settings" => "Background Settings",
	"web_background_Setting" => "Web background Setting",
	"industry" => "Industry",
	"Quotation" => "Quotation",
	"Trade Shows" => "Trade Shows",
	"Buyers" => "Buyers",
	"Stock Sale" => "Stock Sale",
	"Membership | Marketplace" => "Membership | Marketplace",
	"Deal Assist" => "Deal Assist",
	"Membership | Deal Rabbit" => "Membership | Deal Rabbit",
	"Buyers | Deal Rabbit" => "Buyers | Deal Rabbit",
	"Stock Sale | Deal Rabbit" => "Stock Sale | Deal Rabbit",
	"CV Submit | Deal Rabbit" => "CV Submit | Deal Rabbit",
	"Job Seeker | Deal Rabbit" => "Job Seeker | Deal Rabbit",
	"StockSale Setting" => "StockSale Setting",
	"Show_Stock" => "Show Stock",
	"Sellers | Deal Rabbit" => "Sellers | Deal Rabbit",
	"Deal Assist | Deal Rabbit" => "Deal Assist | Deal Rabbit",
	"Trade Shows | Deal Rabbit" => "Trade Shows | Deal Rabbit",
	"Category_management" => "Category management",
	"Category_list" => "Category list",
	"Add_category" => "Add category",
	"Job_Category_Add" => "Job Category Add",
	"Add New Job Category" => "Add New Job Category",
	...
	"Job Categories List" => "Job Categories List",
	"Actions" => "Actions",
	"View Category" => "View Category",
	"Created At" => "Created At",
	"Updated At" => "Updated At",
	"Edit Category" => "Edit Category",
	"Stock_Category_list" => "Stock Category list",
	"Stock_Category_Add" => "Stock Category Add",
	"Add New Stock Category" => "Add New Stock Category",
	"Create Stock Category" => "Create Stock Category",
	"Quotation | Deal Rabbit" => "Quotation | Deal Rabbit",
	"Stock Sale Setting" => "Stock Sale Setting",
	"Category Management" => "Category Management",
	"Tradeshow_Category_list" => "Tradeshow Category list",
	"Tradeshow Categories List" => "Tradeshow Categories List",
	"Tradeshow_Category_Add" => "Tradeshow Category Add",
	"Add New Tradeshow Category" => "Add New Tradeshow Category",
	"Create Tradeshow Category" => "Create Tradeshow Category",
	"Show Date" => "Show Date",
	...
	"Stock Sale | Deal Rocket" => "Stock Sale | Deal Rocket",
	"CV Submit | Deal Rocket" => "CV Submit | Deal Rocket",
	"Trade Shows | Deal Rocket" => "Trade Shows | Deal Rocket",
	"Buyers | Deal Rocket" => "Buyers | Deal Rocket",
	"Sellers | Deal Rocket" => "Sellers | Deal Rocket",
	"Quotation | Deal Rocket" => "Quotation | Deal Rocket",
	"Provide industry insights and leads" => "Provide industry insights and leads",
	"Consultant" => "Consultant",
	"For Buyers" => "For Buyers",
	"Sign up and get access to 1000+ suppliers" => "Sign up and get access to 1000+ suppliers",
	"Trade leads" => "Trade leads",
	"Bulk stock and trade shows" => "Bulk stock and trade shows",
	"For Suppliers" => "For Suppliers",
	"Sign up and get access to 1000+ buy leads" => "Sign up and get access to 1000+ buy leads",
	"Sell your hot products" => "Sell your hot products",
	"Sell your bulk stock quickly" => "Sell your bulk stock quickly",
	"For Consultants" => "For Consultants",
	"Consult with suppliers and buyers globally" => "Consult with suppliers and buyers globally",
	"Assist in market expansion and trade shows" => "Assist in market expansion and trade shows",
	"Deal Assist | Deal Rocket" => "Deal Assist | Deal Rocket",
	"Job Seeker | Deal Rocket" => "Job Seeker | Deal Rocket",
	"Membership | Deal Rocket" => "Membership | Deal Rocket",
	"Vendor_Settings" => "Vendor Settings",
	"Vendor Setting" => "Vendor Setting",
	"Agro Tradex | Deal Rocket" => "Agro Tradex | Deal Rocket",
	...
	"Membership Create Plan" => "Membership Create Plan",
	"Create Membership Tier" => "Create Membership Tier",
	"Membership ID" => "Membership ID",
	"Membership Name" => "Membership Name",
	"Membership Benefits" => "Membership Benefits",
	"Membership Type" => "Membership Type",
	"Select Membership Type" => "Select Membership Type",
	"Free" => "Free",
	"Premium" => "Premium",
	"Membership Active" => "Membership Active",
	"Membership Order" => "Membership Order",
	"Membership Name/Tier (Ex. Free or Premium)" => "Membership Name/Tier (Ex. Free or Premium)",
	"Membership Name / Tier (Ex. Free or Premium)" => "Membership Name / Tier (Ex. Free or Premium)",
	"successfully updated" => "Successfully updated",
	"Homepage Settings" => "Homepage Settings",
	"web_Homepage_Setting" => "Web Homepage Setting",
	"hot_categories" => "Hot categories",
	"hot_Categories" => "Hot Categories",
	"Genre Settings" => "Genre Settings",
	"Home Page Settings" => "Home Page Settings",
	"Homepage Second Settings" => "Homepage Second Settings",
	"Homepage Second Setting" => "Homepage Second Setting",
	"Section" => "Section",
	"Heading" => "Heading",
	"Sub Text" => "Sub Text",
	"Link" => "Link",
	"Sub Text Font Color" => "Sub Text Font Color",
	"Bauble Icon" => "Bauble Icon",
	"Bauble Text" => "Bauble Text",
	"Bauble Link" => "Bauble Link",
	"Bauble Text Font Color" => "Bauble Text Font Color",
	"Save Settings" => "Save Settings",
	"Search By Country | Deal Rocket" => "Search By Country | Deal Rocket",
	...
	"Skills and Additional Information" => "Skills and Additional Information",
	"Bio and Professional Information" => "Bio and Professional Information",
	"Write a short bio" => "Write a short bio",
	"Enter your LinkedIn profile URL" => "Enter your LinkedIn profile URL",
	"Enter your portfolio URL" => "Enter your portfolio URL",
	...
	"List your portfolio items" => "List your portfolio items",
	"Add links to your videos" => "Add links to your videos",
	"website_Settings" => "Website Settings",
	"first_Header_Color" => "First Header Color",
	"second_Header_Color" => "Second Header Color",
	...
	"Disabled" => "Disabled",
	"Boxes Settings" => "Boxes Settings",
	"Recommended_Suppliers" => "Recommended Suppliers",
	"Store Views" => "Store Views",
	"Ready_to_Order" => "Ready to Order",
	"Vendor_Activity" => "Vendor Activity",
	"active_listings" => "Active listings",
	"buy_leads_responded" => "Buy leads responded",
	"job_postings" => "Job postings",
	"deal_assist_requests" => "Deal assist requests",
	...
	"trade_show_registrations" => "Trade show registrations",
	...
	"Job Panel | Deal Rocket" => "Job Panel | Deal Rocket",
	"country_setup" => "Country setup",
	"Countries_Settings" => "Countries Settings",
	"country_Setup_Settings" => "Country Setup Settings",
	...
	"Trade Shows Management" => "Trade Shows Management",
	"Content Moderation" => "Content Moderation",
	"Notifications & Messaging" => "Notifications & Messaging",
	"Analytics & Reports" => "Analytics & Reports",
	"Vendor Dashboard" => "Vendor Dashboard",
	"Profile Management" => "Profile Management",
	"Vendor Listings" => "Vendor Listings",
	"Vendor Jobs Management" => "Vendor Jobs Management",
	"Vendor Trade Shows" => "Vendor Trade Shows",
	...
	"Welcome to Analytics Options" => "Welcome to Analytics Options",
	"Overall Analytics" => "Overall Analytics",
	"Sales & Transactions Reports" => "Sales & Transactions Reports",
	...
	"Small Orders Accepted" => "Small Orders Accepted",
	"Main Export Markets" => "Main Export Markets",
	...
	"Lead Time" => "Lead Time",
	"QC Staff Count" => "QC Staff Count",
	"Inspection Process" => "Inspection Process",
	"Testing Equipment" => "Testing Equipment",
	"QC Certifications" => "QC Certifications",
	"R&D Staff Count" => "R&D Staff Count",
	"Patents" => "Patents",
	"Annual R&D Spending" => "Annual R&D Spending",
	"Customization Offered" => "Customization Offered",
	"Product Development Time" => "Product Development Time",
	...
	"enter_available_stock" => "Enter available stock",
	"available_stock_unit" => "Available stock unit",
	"enter_available_stock_unit" => "Enter available stock unit",
	"lead_time" => "Lead time",
	"enter_lead_time" => "Enter lead time",
	"enter_brand" => "Enter brand",
	"enter_payment_option" => "Enter payment option",
	"offer_type" => "Offer type",
	"enter_offer_type" => "Enter offer type",
	...
	"HTS Code" => "HTS Code",
	"Export Carton Dimensions (L x W x H)" => "Export Carton Dimensions (L x W x H)",
	"Logistics Attributes" => "Logistics Attributes",
	"Dimensions per Unit" => "Dimensions per Unit",
	"Units per Export Carton" => "Units per Export Carton",
	"Export Carton Weight" => "Export Carton Weight",
	"Regions" => "Regions",
	...
	"Buyers | Deal Rockets" => "Buyers | Deal Rockets",
	"Upload Banner" => "Upload Banner",
	"Bulk Import" => "Bulk Import",
	"Manage Stock Sell" => "Manage Stock Sell",
	"Add Stock Sell" => "Add Stock Sell",
	"Sale Offer" => "Sale Offer",
	"Manage Sale Offer" => "Manage Sale Offer",
	...
	"Stock Sale | Deal Rockets" => "Stock Sale | Deal Rockets",
	"Deal Assist | Deal Rockets" => "Deal Assist | Deal Rockets",
	"Sellers | Deal Rockets" => "Sellers | Deal Rockets",
	"RFQ | Deal Rockets" => "RFQ | Deal Rockets",
	"Job Landing | Deal Rockets" => "Job Landing | Deal Rockets",
	"Job Seeker | Deal Rockets" => "Job Seeker | Deal Rockets",
	...
	"Agro Tradex | Deal Rockets" => "Agro Tradex | Deal Rockets",
	...
	"Toggle" => "Toggle",
	"Vendor Register Forms" => "Vendor Register Forms",
	"Register Form Information" => "Register Form Information",
	...
	"Top Vendor Products" => "Top Vendor Products",
	"Local Currency if Not US Dollar" => "Local Currency if Not US Dollar",
	"Master Packing Type" => "Master Packing Type",
	"Load Capacity per Lot" => "Load Capacity per Lot",
	"Internal Packing Type" => "Internal Packing Type",
	...
	"job search logs" => "Job search logs",
	"membership tiers" => "Membership tiers",
	"new product stores" => "New product stores",
	"regions" => "Regions",
	"search hist users" => "Search hist users",
	"solution categories" => "Solution categories",
	"solution sub categor..." => "Solution sub categor...",
	"solutions" => "Solutions",
	"stock category" => "Stock category",
	"subregions" => "Subregions",
	"table jobprofile" => "Table jobprofile",
	"trade category" => "Trade category",
	"vendor extra details" => "Vendor extra details",
	...
	"Stock_Sell_List" => "Stock Sell List",
	...
	"actions" => "Actions",
	"membership_tier" => "Membership tier",
	"all_membership_tiers" => "All membership tiers",
	"all_companies" => "All companies",
	"Job_Vacancies_List" => "Job Vacancies List",
	"closed" => "Closed",
	...
	"Hire" => "Hire",
	"Graphics and Dashboard Allotment" => "Graphics and Dashboard Allotment",
	"Finance & Accounting" => "Finance & Accounting",
	"Grievance & Complain" => "Grievance & Complain",
	...
	"search_by_user_name_or_job_title" => "Search by user name or job title",
	...
	"Choose Your Membership Plan" => "Choose Your Membership Plan",
	"Unlock premium features and exclusive benefits with our membership plans" => "Unlock premium features and exclusive benefits with our membership plans",
	"forever" => "Forever",
	...
	"Monthly" => "Monthly",
	"Secure" => "Secure",
	"Choose your preferred payment method to complete the purchase" => "Choose your preferred payment method to complete the purchase",
	"Proceed to Payment" => "Proceed to Payment",
	"You will be redirected to the payment gateway to complete your transaction securely" => "You will be redirected to the payment gateway to complete your transaction securely",
	"Please select a payment method" => "Please select a payment method",
	"Are you sure you want to proceed with payment?" => "Are you sure you want to proceed with payment ",
	"Complete Purchase" => "Complete Purchase",
	"Secure payment processing with 256-bit SSL encryption" => "Secure payment processing with 256-bit SSL encryption",
	"Yearly" => "Yearly",
	"Premium Features:" => "Premium Features:",
	"/month" => "/month",
	"Join This Plan" => "Join This Plan",
	"/year" => "/year",
	"Solutions | Deal Rockets" => "Solutions | Deal Rockets",
	"Job Applied | Deal Rockets" => "Job Applied | Deal Rockets",
	...
	"created_date_ascending" => "Created date ascending",
	"created_date_descending" => "Created date descending",
	"Check Vendor Registration Form" => "Check Vendor Registration Form",
	...
	"Search_by_email_or_phone" => "Search by email or phone",
	"Enter_email_or_phone" => "Enter email or phone",
	...
	"quote" => "Quote",
	"blocked" => "Blocked",
	"Quotation & Services Setting" => "Quotation & Services Setting",
	"Ads Manager" => "Ads Manager",
	"Tradeshow_Banner_Settings" => "Tradeshow Banner Settings",
	...
	"Vendors Shown" => "Vendors Shown",
	"Page" => "Page",
	"No ads found for the applied filters." => "No ads found for the applied filters.",

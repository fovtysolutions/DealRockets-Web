        ...
        <div class="responsive-1 deleleventeen">
          <div class="div">
            <div class="group-2" style="margin-right:40px;">
              ...
              <div class="col-md-6 product-category" style="text-align: left; margin-bottom:16px;">
                <!-- Adjust column size to split into two columns -->
                <span class="fw-bold d-flex"
                style="text-transform: uppercase; font-weight: 500 !important; align-content: start; font-size: 10px; color:#0D0D0F;">{{ $c['name'] }}
                <a href="{{ route('products', ['category_id' => $c['id'], 'data_from' => 'category', 'page' => 1]) }}"
                  class="view-more custom-dealrock-subtext" onclick="toggleViewMore(this)"
                  style="color: var(--web-text) !important; text-transform:none;">
                  - See More
                </a>
                </span>
                <span class="product-list"
                style="height:44px; overflow:hidden; display: inline-block; line-height: 1rem;height: calc(1rem * 3);">
                @foreach($c['products'] as $d)
            <a href="{{ route('product', ['slug' => $d['slug']]) }}"
              class="product-link custom-dealrock-subtext"
              style="font-size: 7px; color: var(--web-text) !important;">
        ...
        <div class="group-16 responsive-1">
          <div class="frame-6">
            <div class="group-17">
              ...
              <div class="frame-7">
                <div class="footer-text"><a href="{{route('products', ['data_from' => 'featured', 'page' => 1])}}"
                    class="text-wrapper-7">Featured Products</a></div>
                <div class="footer-text"><a href="{{route('products', ['data_from' => 'latest', 'page' => 1])}}"
                    class="text-wrapper-7">Latest Products</a></div>
                <div class="footer-text"><a href="{{route('products', ['data_from' => 'best-selling', 'page' => 1])}}"
                    class="text-wrapper-7">Best Selling Products</a></div>
                <div class="footer-text"><a href="{{route('products', ['data_from' => 'top-rated', 'page' => 1])}}"
            ...
            <div class="group-18">
              ...
              <div class="frame-7">
                <div class="footer-text"><a class="text-wrapper-7" href="{{route('user-account')}}">Profile Info</a>
                </div>
                <div class="footer-text"><a class="text-wrapper-7" href="{{route('wishlists')}}">Wish list</a></div>
                <div class="footer-text"><a class="text-wrapper-7" href="{{route('track-order.index')}}">Track Order</a>
                </div>
              </div>
            </div>
            <div class="group-17">
              ...
              <div class="frame-7">
                <div class="footer-text"><a href="{{route('refund-policy')}}" class="text-wrapper-7">Refund policy</a>
                </div>
                <div class="footer-text"><a href=" {{route('return-policy')}} " class="text-wrapper-7">Return policy</a>
                </div>
                <div class="footer-text"><a href="{{route('cancellation-policy')}}" class="text-wrapper-7">Cancellation
                    policy</a></div>
            ...
            <div class="group-19">
              ...
              <div class="frame-7">
                ...
                <div class="footer-text"><a href="{{route('account-tickets')}}" class="text-wrapper-7">Support
                    ticket</a></div>
              </div>
            </div>
          </div>

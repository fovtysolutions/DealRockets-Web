        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-3">
                    <div class="mb-3">
                        <h4 class="mb-2 footer-title">Discover Products & Suppliers</h4>
                    ...
                    <h4 class="mb-2 footer-title">Featured Service</h4>
                    <ul class="footer-menu">
                        <li class="mb-1">
                            <a href="#">Star Buyer</a>
                        </li>
                ...
                <div class="col-12 col-md-3">
                    <div class="mb-3">
                        <h4 class="mb-2 footer-title">About Us</h4>
                        <ul class="footer-menu">
                            <li class="mb-1">
                                <a href={{ route('about-us') }}>About Marketplace.com</a>
                            </li>
                            <li class="mb-1">
                                <a href="#">Site Map</a>
                            </li>
                    ...
                    <h4 class="mb-2 footer-title">Help</h4>
                    <ul class="footer-menu">
                        <li class="mb-1">
                            <a href={{ route('helpTopic') }}>FAQ</a>
                        </li>
                        <li class="mb-1">
                            <a href={{ route('contacts') }}>Contact Us</a>
                        </li>
                        <li class="mb-1">
                            <a href={{ route('contacts') }}>Submit a Complaint</a>
                        </li>
                    </ul>
                </div>
                <div class="col-12 col-md-3">
                    <div class="mb-3">
                        <h4 class="mb-2 footer-title">Language Options</h4>
                        <div class="d-flex">
                            <div class="col-6">
                                <ul class="footer-menu">
                                    @foreach(json_decode($language['value'], true) as $key => $data)
                                        @if($data['status'] == 1)
                                            <li class="change-language __inline-17" data-action="{{route('change-language')}}"
                                                data-language-code="{{$data['code']}}" style="display: list-item;">
                                                <a class="mb-1" href="javascript:">
                ...
                <div class="col-12 col-md-3">
                    <div class="mb-3">
                        <div class="footer-brands">
                            ...
                            <div class="brand-subtitle">Co-brands</div>
                            <div class="brand-item brand-1">
                                <a href="#"></a>
                            </div>
                            <div class="brand-item brand-2">
                                <a href="#"></a>
                            </div>
                            <!-- <div class="brand-item brand-3">
                                <a href="#"></a>
                            </div>
                            <div class="brand-item brand-4">
                                <a href="#"></a>
                            </div> -->
                        </div>
                    </div>
        ...
        <!-- <div class="container">
            <div class="col-md-4 col-12">
                <div class="footer-app">
                    <span>Free App:</span>
                    <a href="#" class="footer-apple-store">
                        <i class="fa fa-apple"></i>
                        App Store
                    </a>
                    <a href="#" class="footer-android-store">

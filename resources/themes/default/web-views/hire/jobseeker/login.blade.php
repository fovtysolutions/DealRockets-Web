            ...
            <div class="right-section">
                <div class="form-container">
                    <div class="form-header">
                        <h2>Welcome to Job Seeker's Sign In!</h2>
                        <p>Sign in to access your job search dashboard, view applications, and discover new career opportunities!</p>
                    </div>
                    ...
                    <form action="{{ route('customer.auth.login') }}" method="post" id="customer-login-form">
                        ...
                        <div class="manual-login-items" style="padding-bottom: 25px;">
                            <!-- Sign Up button -->
                            <button type="submit" class="submit-btn" id="submit-hr" style="background: rgba(191, 158, 102, 1);">Sign In</button>
                        </div>

                        <!-- Sign up link -->
                        <div class="signup-link">
                            Don't have an account?
                            <a href="{{ route('customer.auth.jobseeker-sign-up') }}" type="button" class="link-btn"  style="color: rgba(191, 158, 102, 1);">Sign Up</a>
                        </div>
                    </form>
                </div>
            </div>

...
@section('content')
@php($decimalPointSettings = !empty(getWebConfig(name: 'decimal_point_settings')) ? getWebConfig(name:
...
{{-- @include('web-views.partials._agrotradexsticker') --}}
...
{{-- @if (count(value: $footer_banner) > 1)

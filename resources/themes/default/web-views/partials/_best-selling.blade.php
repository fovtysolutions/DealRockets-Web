<div class="mainpagesection">
    <div class="card card __shadow h-100" style="/* border-radius: 10px; */">
            ...
            <div class="row d-flex justify-content-between mx-1 mb-3">
                <div class="d-flex flex-row">
                    <img class="size-30" src="{{theme_asset(path: "public/assets/front-end/png/best-sellings.png")}}"
                         alt="">
                    <span class="pl-1 custom-dealrock-head">{{ translate('best_sellings')}}</span>
                </div>
                <div>
            ...
            <div class="row g-3">
                @foreach($bestSellProduct as $key=>$bestSell)
                    @if($bestSell->product && $key < 6)
                        <div class="col-md-2 col-sm-4 col-6"> <!-- Use col-md-2 for 6 items in a row on medium screens -->
                            <a class="__best-selling" href="{{route('product',$bestSell->product->slug)}}">
                                ...
                                <div class="d-flex flex-wrap">
                                    <div class="best-selleing-image overflow-hidden">
                                        <img class="rounded"

...
<section>
    <div class="sourcenow-sec">
        <div class="sourcemaindiv d-flex">
            <!-- Left Banner Section -->
            <div class="sourcefirstdiv bg-shimmer" data-bg='{{ isset($homepagesetting[1]['background_image']) ? asset('storage/' . $homepagesetting[1]['background_image']) : asset('/images/placeholderimage.webp') }}'>
                <div class="cnt-1">

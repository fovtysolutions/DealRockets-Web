...
<section>
    <div class="sourcenow-sec">
        <div class="sourcemaindiv d-flex">
            <!-- Left Banner Section -->
            <div class="sourcefirstdiv bg-shimmer" data-bg='{{ 'storage/' . $homepagesetting[1]['background_image'] }}'>
                <div class="cnt-1">
                ...
                <div class="prd-grid firstshow">
                    ...
                    <div class="prd-item">
                        <a style="all: unset; cursor: pointer;"
                            href="{{ route('products', ['searchInput' => $homepagesetting[1]['products'][$i]['name']]) }}"
                            ...
                            <div class="source-product-item image-wrapper shimmer">
                                <div class="product-name text-left d-flex flex-column justify-content-center">
                                    <p class="custom-dealrock-text">{{ $homepagesetting[1]['products'][$i]['name'] }}
                                    </p>
                                </div>
                                {{-- <div class="redtriangle"> --}}
                                <img data-src="storage/{{ $homepagesetting[1]['products'][$i]['image'] }}"

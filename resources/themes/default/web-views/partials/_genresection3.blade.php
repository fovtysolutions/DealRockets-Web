...
$colorat = ChatManager::getimagecolorat('storage/' . ($homepagesetting[3]['background_image'] ?? ''), 15, 15) ?? $defaultColor;
...
$getcategoryid = optional(Category::where('name', $homepagesetting[3]['category_title'] ?? '')->first())->id ?? 0; // default ID 1
?>
...
<section>
    <div class="sourcenow-sec">
        <div class="sourcemaindiv d-flex">
            <!-- Left Banner Section -->
            <div class="sourcefirstdiv bg-shimmer" data-bg='{{ 'storage/' . ($homepagesetting[3]['background_image'] ?? 'default-bg.jpg') }}'>
                <div class="cnt-1">

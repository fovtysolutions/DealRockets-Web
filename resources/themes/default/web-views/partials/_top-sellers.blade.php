    <div class="mainpagesection seller-card custom-dealrock-banner-small">
        <div class="card __shadow h-100">
            <div class="card-body" style="display:block;">
                <div class="row d-flex justify-content-between">
                    <div class="seller-list-title">
                        <h5 class="m-0 text-capitalize custom-dealrock-head" style="color: black; font-size: 20px;">
                        ...
                        @foreach ($topVendorsList as $vendorData)
                            <a href="{{route('shopView',['id'=> $vendorData['id']])}}" class="others-store-card text-capitalize">
                                ...
                                <div class="name-area">
                                    ...
                                    <div class="info pt-2">
                                        <h5  class="custom-dealrock-text">{{ $vendorData->name }}</h5>

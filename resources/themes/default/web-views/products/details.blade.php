                            ...
                            <div class="cz-product-gallery">
                                ...
                                <div class="d-flex flex-column gap-3">
                                    <button type="button" data-product-id="{{$product['id']}}"
                                        ...
                                        <i style="color:white;" class="fa {{($wishlistStatus == 1?'fa-heart':'fa-heart-o')}} wishlist_icon_{{$product['id']}} web-text-primary"
                                           aria-hidden="true"></i>
                                        ...
                                        <div class="product-quantity d-flex flex-column __gap-15">
                                            <div class="d-flex align-items-center gap-3">
                                                ...
                                                <div class="d-flex justify-content-center align-items-center quantity-box border rounded border-base web-text-primary">
                                                    ...
                                                    <input type="text" name="quantity" style="color:black !important;"
                                    ...
                                    @if($membership['status'] == 'active')
                                        ...
                                        <a class="d-block">
                                            <div class="d-flex __seller-author align-items-center">
                                                <div>
                                                    <img class="__img-60 img-circle" alt=""
                                                         src="{{ theme_asset('public/assets/front-end/img/placeholder/user.png') }}">
                                                </div>
                                                    <div class="ms-2 w-0 flex-grow" style="color: transparent;text-shadow: 0 0 8px #000;">
                                                        <h6 style="color: transparent;text-shadow: 0 0 8px #000;">
                                                            Buy Membership first
                                                        </h6>
                                                        <span class="text-capitalize">{{translate('vendor_info')}}</span>
                                                    </div>
                                            </div>

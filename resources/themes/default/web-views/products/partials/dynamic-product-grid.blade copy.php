@foreach ($products as $item)
    <div class="product-card">
        ...
        <img src="{{ isset($item->thumbnail) ? '/storage/product/thumbnail/' . $item->thumbnail : '/images/placeholderimage.webp' }}" alt="Sample Product" onerror="this.onerror=null; this.src='/images/placeholderimage.webp';" class="product-image">

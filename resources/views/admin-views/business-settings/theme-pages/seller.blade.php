...
@section('title', translate('Seller Setting'))
...
<div class="content container-fluid">
    <div class="mb-4 pb-2">
        <h2 class="h1 mb-0 text-capitalize d-flex align-items-center gap-2">
            ...
            {{translate('Seller Setting')}}
        </h2>
    </div>
    @include('admin-views.business-settings.theme-pages.theme-pages-selector')
    <div class="d-flex card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.webtheme.sellerform') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label for="limit">Seller Leads Limit</label>
                ...
                <div class="row">
                    <div class="col-md-6 form-group">
                        <label for="color">Seller Theme Color</label>

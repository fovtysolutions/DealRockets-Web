            ...
            <div class="row">
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-wrap gap-4 justify-content-around">
                            <div class="form-group">
                                <input type="color" name="first_header_color" value="{{ $businessSetting['first_header_color'] }}"
                                       class="form-control form-control_color">
                                <div class="text-center">
                                    <div
                                        class="title-color mb-4 mt-3">{{ strtoupper($businessSetting['first_header_color']) }}</div>
                                    <label class="title-color text-capitalize">{{translate('first_Header_Color')}}</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="color" name="second_header_color" value="{{ $businessSetting['second_header_color'] }}"
                                       class="form-control form-control_color">
                                <div class="text-center">
                                    <div
                                        class="title-color mb-4 mt-3">{{ strtoupper($businessSetting['second_header_color']) }}</div>
                                    <label class="title-color text-capitalize">
                                        {{translate('second_Header_Color')}}
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-wrap gap-4 justify-content-around">
                            <div class="form-group">
                                <input type="color" name="bgcolor" value="{{ $businessSetting['bg_color'] ?? ''}}"
                                       class="form-control form-control_color">
                                <div class="text-center">
                                    <div
                                        class="title-color mb-4 mt-3">{{ strtoupper($businessSetting['bg_color'] ?? '') }}</div>
                                    <label class="title-color text-capitalize">{{translate('bg_color')}}</label>
                                </div>
                            </div>
                            @if(theme_root_path() == 'theme_aster')
                                <div class="form-group">
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-wrap gap-4 justify-content-around">
                            <div class="form-group">
                                <input type="color" name="textcolor" value="{{ $businessSetting['text_color'] ?? '#000' }}"
                                       class="form-control form-control_color">
                                <div class="text-center">
                                    <div
                                        class="title-color mb-4 mt-3">{{ strtoupper($businessSetting['text_color'] ?? '#000') }}</div>
                                    <label class="title-color text-capitalize">{{translate('text_Color')}}</label>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="color" name="hovercolor" value="{{ $businessSetting['hover_color'] ?? '#000' }}"
                                       class="form-control form-control_color">
                                <div class="text-center">
                                    <div
                                        class="title-color mb-4 mt-3">{{ strtoupper($businessSetting['hover_color'] ?? '#000') }}</div>
                                    <label class="title-color text-capitalize">
                                        {{translate('highlight_Color')}}
                                    </label>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-banner-logo"
                                     src="{{ getStorageImages(path: $businessSetting['banner_logo'] , type: 'backend-basic') }}"alt="">
                            </div>
                            <div class="position-relative mt-4">
                                <input type="file" name="company_banner_logo" id="website-banner-logo"
                                       class="custom-file-input image-input" data-image-id="view-website-banner-logo"
                                       accept=".webp, .jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label text-capitalize"
                                       for="website-banner-logo">{{translate('choose_file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-banner-logo1"
                                     src="{{ getStorageImages(path: $businessSetting['banner_logo1'] , type: 'backend-basic') }}"alt="">
                            </div>
                            <div class="position-relative mt-4">
                                <input type="file" name="company_banner_logo1" id="website-banner-logo1"
                                       class="custom-file-input image-input" data-image-id="view-website-banner-logo1"
                                       accept=".webp, .jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label text-capitalize"
                                       for="website-banner-logo1">{{translate('choose_file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-banner-logo2"
                                     src="{{ getStorageImages(path: $businessSetting['banner_logo2'] , type: 'backend-basic') }}"alt="">
                            </div>
                            <div class="position-relative mt-4">
                                <input type="file" name="company_banner_logo2" id="website-banner-logo2"
                                       class="custom-file-input image-input" data-image-id="view-website-banner-logo2"
                                       accept=".webp, .jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label text-capitalize"
                                       for="website-banner-logo2">{{translate('choose_file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xxl-4 col-sm-6 mb-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body d-flex flex-column justify-content-around">
                            <div class="d-flex justify-content-center">
                                <img height="60" id="view-website-banner-logo3"
                                     src="{{ getStorageImages(path: $businessSetting['banner_logo3'] , type: 'backend-basic') }}"alt="">
                            </div>
                            <div class="position-relative mt-4">
                                <input type="file" name="company_banner_logo3" id="website-banner-logo3"
                                       class="custom-file-input image-input" data-image-id="view-website-banner-logo3"
                                       accept=".webp, .jpg, .png, .jpeg, .gif, .bmp, .tif, .tiff|image/*">
                                <label class="custom-file-label text-capitalize"
                                       for="website-banner-logo3">{{translate('choose_file')}}</label>
                            </div>
                        </div>
                    </div>
                </div>

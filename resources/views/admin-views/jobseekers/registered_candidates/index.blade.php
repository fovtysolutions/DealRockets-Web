    ...
    <div class="row mb-4 mt-4">
        <div class="col-md-12 d-flex justify-content-between">
            ...
            <div class="action-buttons">
                <a href="{{ route('admin.jobvacancy.create') }}" class="btn btn-success"><i class="fa fa-plus"></i>
                    Create
                    Vacancy</a>
            </div>
        </div>
            ...
            <table class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <th>
                            ...
                            @if (request('sort_by') == 'title')
                                <span class="badge badge-info">{{ request('sort_order') == 'asc' ? '▲' : '▼' }}</span>
                            @endif
                        </th>
                        <th>
                            <a
                ...
                <tbody>
                    @foreach ($vacancies as $vacancy)
                        <tr>
                            <td><input type="checkbox" class="job-checkbox" data-id="{{ $vacancy->id }}"></td>
                            <td>{{ $vacancy->title }}</td>
                            <td>{{ $vacancy->company_name }}</td>
                            <td>{{ ucfirst($vacancy->status) }}</td>
                            <td>{{ \App\Models\JobCategory::where('id',$vacancy->category)->first()->name }}</td>
                            ...
                            <td>
                                ...
                                <form action="{{ route('admin.jobvacancy.destroy', $vacancy->id) }}" method="POST"

...
@section('title', translate('Stock_Category_Add'))
    ...
    <div class="content-wrapper">
        <section class="content-header mt-5">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1>{{ translate('Add New Stock Category') }}</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{ route('admin.stock.category.list') }}">{{ translate('Categories') }}</a></li>
            ...
            <div class="container-fluid">
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">{{ translate('Create Stock Category') }}</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                        <form action="{{ route('admin.stock.category.store') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <a href="{{ route('admin.stock.category.list') }}" class="btn btn-secondary">{{ translate('Back to List') }}</a>
                            </div>
                        </form>
                    </div>
                    <!-- /.card-body -->

...
@section('title', translate('Stock_Category_list'))
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="" role="group" style="display: flex;gap: 10px;align-items: center;">
                                                ...
                                                <form action="{{ route('admin.stock.category.destroy', $category->id) }}" method="POST" onsubmit="return confirm('Are you sure?');" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1" role="dialog" aria-labelledby="editCategoryModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.stock.category.update', ':id') }}" method="POST" id="editCategoryForm">
                    @csrf
                    @method('POST')
                    <div class="modal-body">

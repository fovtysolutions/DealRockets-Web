...
@section('title', translate('Stock_Sale_Messages'))
...
<input type="hidden" name="reciever_typemew" id="reciever_typemew" value="admin">
<input type="hidden" name="typemew" id="typemew" value="stocksale">
    <!-- char-area -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="send-box">
                                        ...
                                        <form id="sendchatmessage">
                                            @csrf
                                            <input type="hidden" name="typereq" id="typereq" value="stocksale">

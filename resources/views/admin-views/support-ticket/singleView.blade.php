            ...
            <div class="card-header flex-wrap gap-3">
                ...
                <div class="media d-flex gap-3">
                    <img class="rounded-circle avatar"
                         src="{{ getStorageImages(path: (isset($ticket->customer)?$ticket->customer->image_full_url:''), type: 'backend-basic') }}" alt=""/>
                                        ...
                                        <div class="row g-2 flex-wrap pt-1 justify-content-end">
                                            @foreach ($message->attachment_full_url as $index => $photo)
                                                <div class="col-6 col-md-2 position-relative img_row{{$index}}">
                                                    <a data-lightbox="mygallery" href="{{ getStorageImages(path: $photo, type: 'backend-basic') }}"

...
@section('title', translate('Tradeshow_Category_list'))
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">{{ translate('Tradeshow Categories List') }}</h3>
                        <a href="{{ route('admin.tradeshow.category.create') }}" class="btn btn-primary btn-sm float-right">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="" role="group" style="display: flex;gap: 10px;align-items: center;">
                                                ...
                                                <form action="{{ route('admin.tradeshow.category.destroy', $category->id) }}" method="POST" onsubmit="return confirm('Are you sure?');" class="d-inline">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal fade" id="editCategoryModal" tabindex="-1" role="dialog" aria-labelledby="editCategoryModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.tradeshow.category.update', ':id') }}" method="POST" id="editCategoryForm">
                    @csrf
                    @method('POST')
                    <div class="modal-body">

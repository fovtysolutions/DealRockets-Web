        ...
        <div class="card">
            <div class="card-body">
                ...
                <h5 class="mb-0 text-capitalize d-flex align-items-center gap-2 border-bottom pb-3 mb-4 pl-4">
                    <img src="{{dynamicAsset(path: 'public/assets/back-end/img/vendor-information.png')}}" class="mb-1"
                        alt="">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 mb-4 mb-lg-0">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control form-control-user" id="exampleLastName" name="l_name"
                                value="{{old('l_name')}}" placeholder="{{translate('ex')}}: Doe" required>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="">
                                    <input type="text" class="country-picker-phone-number w-50" value="{{old('phone')}}"
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="form-group">
                            <div class="title-color mb-2 d-flex gap-1 align-items-center">{{translate('vendor_Image')}}
                ...
                <div class="row">
                    <div class="col-lg-4 form-group">
                        ...
                        <input type="email" class="form-control form-control-user" id="exampleInputEmail" name="email"
                            value="{{old('email')}}" placeholder="{{translate('ex').':'.'Jhone@company.com'}}" required>
                    </div>
                    <div class="col-lg-4 form-group">
        ...
        <div class="card mt-3">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 form-group">
                        ...
                        <input type="number" class="form-control form-control-user" id="shop_years" name="shop_years"
                            placeholder="{{translate('ex') . ':' . translate('2')}}" value="{{old('shop_years')}}" required>
                    </div>
                    <div class="col-lg-6 form-group">
                        <div class="d-flex justify-content-center">
                ...
                <div class="d-flex align-items-center justify-content-end gap-10">
                    ...
                    <button type="button" class="btn btn--primary btn-user form-submit" data-form-id="add-vendor-form"

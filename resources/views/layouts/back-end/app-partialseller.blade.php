...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" dir="{{ Session::get('direction') }}"
    style="text-align: {{ Session::get('direction') === 'rtl' ? 'right' : 'left' }}; overflow: hidden;">
...
<head>
    ...
    {{-- CSS Stylesheets --}}
    <link rel="stylesheet" href="{{ dynamicAsset('public/assets/back-end/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ dynamicAsset('public/assets/back-end/css/vendor.min.css') }}">
    ...
    @if (Session::get('direction') === 'rtl')
        <link rel="stylesheet" href="{{ dynamicAsset('public/assets/back-end/css/menurtl.css') }}">
    @endif
    ...
    <style>
        select {
            background-image: url('{{ dynamicAsset('public/assets/back-end/img/arrow-down.png') }}');
            background-size: 7px;

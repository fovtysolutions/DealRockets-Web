...
<head>
    ...
    {{-- Stack for additional CSS or JS --}}
    @stack('css_or_js')
...
<body class="footer-offset">
    ...
    <span id="get-customer-list-without-all-customer-route"
        data-action="{{route('admin.customer.customer-list-without-all-customer')}}"></span>

    <span id="get-search-product-route" data-action="{{route('admin.products.search-product')}}"></span>
    <span id="get-multiple-product-details-route"
        data-action="{{route('admin.products.multiple-product-details')}}"></span>
    ...
    <span id="get-product-stock-view" data-stock-limit-page="{{route('admin.products.stock-limit-list', ['in_house'])}}">
    </span>

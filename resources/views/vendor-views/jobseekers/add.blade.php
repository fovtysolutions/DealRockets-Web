...
@section('content')
    <div class="container mt-5">
        <form action="{{ route('vendor.jobvacancy.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
            <div class="card">
                <div class="card-body">
                    <div class="progress-form-main">
                        ...
                        <div class="form-header">
                            <h1>{{ translate('Add New Vacancy') }}</h1>
                            <p>Fill in the required details to add a new job vacancy</p>
                        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="employment_space" id="employment_space" required>
                                        <option value="work-from-home" {{ old('employment_space') == 'work-from-home' ? 'selected' : '' }}>
                                            Work From Home</option>
                                        <option value="in-office" {{ old('employment_space') == 'in-office' ? 'selected' : '' }}>
                                            In Office</option>
                                        <option value="hybrid" {{ old('employment_space') == 'hybrid' ? 'selected' : '' }}>
                                            Hybrid</option>
                                    </select>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="remote" name="remote" required>
                                        <option value="0" {{ old('remote') == '0' ? 'selected' : '' }}>{{ translate('No') }}</option>
                                        <option value="1" {{ old('remote') == '1' ? 'selected' : '' }}>{{ translate('Yes') }}</option>
                                    </select>
                                    @error('remote')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                        ...
                        <div class="step-section" data-step="4">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="experience_required"
                                        name="experience_required" value="{{ old('experience_required') }}"
                            ...
                            <button type="submit" class="submit-btn">{{ translate('Add Vacancy') }}</button>
                        </div>
                    </div>
                </div>
            </div>

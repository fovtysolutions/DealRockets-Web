            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5 class="card-title">{{ translate('Add New Vacancy') }}</h5>
                    </div>
                    <div class="card-body">
                        <!-- Add Vacancy Form -->
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="employment_space" id="employment_space"
                                                    ...
                                                    <option value="work-from-home"
                                                        {{ old('employment_space') == 'work-from-home' ? 'selected' : '' }}>
                                                        Work From Home</option>
                                                    <option value="in-office"
                                                        {{ old('employment_space') == 'in-office' ? 'selected' : '' }}>
                                                        In Office</option>
                                                    <option value="hybrid"
                                                        {{ old('employment_space') == 'hybrid' ? 'selected' : '' }}>
                                                        Hybrid</option>
                                                </select>

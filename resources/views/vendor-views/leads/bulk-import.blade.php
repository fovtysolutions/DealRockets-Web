...
@section('title', translate('Leads_Bulk_Import'))
    ...
    <div class="content container-fluid">
        ...
        <div class="row text-start">
            ...
            <div class="col-md-12 mt-2">
                <form class="product-form" action="{{route('vendor.leads.bulk.import')}}" method="POST"
                    ...
                    <div class="card rest-part">
                        <div class="px-3 py-4 d-flex flex-wrap align-items-center gap-10 justify-content-center">
                            ...
                            <a href="{{dynamicAsset(path: 'public/assets/leads_bulk_format.xlsx')}}" download=""
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-auto">
                                        ...
                                        <div class="uploadDnD">
                                                ...
                                                <input type="file" name="leads_file" accept=".xlsx, .xls" class="form-control-file text--primary font-weight-bold action-upload-section-dot-area" id="inputFile">
                                            </div>
                                        </div>

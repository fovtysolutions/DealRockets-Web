    ...
    <div class="content container-fluid">
        ...
        <form class="product-form text-start" action="{{ route('vendor.leads.update', $leads->id) }}" method="POST"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @foreach ($languages as $lang)
                        <div class="{{ $lang != $defaultLanguage ? 'd-none' : '' }} form-system-language-form row"
                            id="{{ $lang }}-form">
                            ...
                            <div class="form-group col-lg-6">
                                ...
                                <select name="type" id="{{ $lang }}_type"
                                    ...
                                    <option selected value="seller"
                                        {{ old('type', $leads->type) == 'seller' ? 'selected' : '' }}>
                                        {{ translate('seller') }}
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" {{ $lang == $defaultLanguage ? 'required' : '' }} name="unit"
                                    id="{{ $lang }}_unit" class="form-control"
                                    placeholder="{{ translate('Enter Unit') }}" value="{{ old('unit', $leads->unit) }}">
                            </div>

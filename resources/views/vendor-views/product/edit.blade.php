...
@section('content')
    <div class="content container-fluid">
        ...
        <form class="product-form text-start"
            action="{{ request('product-gallery') == 1 ? route('vendor.products.add') : route('vendor.products.update', $product->id) }}"
                    ...
                    @foreach ($languages as $language)
                        ...
                        <div class="{{ $language != 'en' ? 'd-none' : '' }} form-system-language-form"
                            ...
                            <div class="form-group pt-4">
                                ...
                                <textarea name="description[]" class="summernote">{!! $translate[$language]['description'] ?? $product['details'] !!}</textarea>
                            </div>
                        </div>
                    @endforeach
                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" placeholder="{{ translate('Enter Origin') }}"
                                            name="origin" data-role="origininput">
                                            <option selected value="{{ $product->origin }}">
                                                {{ \App\Models\Country::where('id', $product->origin)->first()->name ?? 'Select a Country' }}
                                            </option>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="usage"
                                placeholder="e.g., Indoor/Outdoor Use" value="{{ $product->usage }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-12">
                            <label class="form-label">{{ translate('Additional Details') }}</label>
                            <div id="dynamic-data-box">
                                @php
                                    $additionalDetailsRaw = isset($product)
                                        ? json_decode($product->additional_details, true)
                                        : [];
                                    $additionalDetails = old(
                                        'additional_details',
                                        is_array($additionalDetailsRaw) ? $additionalDetailsRaw : [],
                                    );
                                @endphp

                                @foreach ($additionalDetails as $index => $detail)
                                    <div class="title-group border rounded p-3 mb-2">
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <input type="text" name="dynamic_data[{{ $index }}][title]"
                                                class="form-control w-75" placeholder="Title"
                                                value="{{ $detail['title'] ?? '' }}">
                                            <button type="button"
                                                class="btn btn-danger btn-sm remove-title-group">Remove</button>
                                        </div>
                                        ...
                                        <div class="sub-heads" data-title-index="{{ $index }}">
                                            @foreach ($detail['sub_heads'] ?? [] as $subIndex => $subhead)
                                                <div class="row mb-2 sub-head-row">
                                                    <div class="col-md-5">
                                                        <input type="text"
                                                            name="dynamic_data[{{ $index }}][sub_heads][{{ $subIndex }}][sub_head]"
                                                            class="form-control" placeholder="Sub Head"
                                                            value="{{ $subhead['sub_head'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-5">
                                                        <input type="text"
                                                            name="dynamic_data[{{ $index }}][sub_heads][{{ $subIndex }}][sub_head_data]"
                                                            class="form-control" placeholder="Sub Head Data"
                                                            value="{{ $subhead['sub_head_data'] ?? '' }}">
                                                    </div>
                                                    <div class="col-md-2">
                                                        <button type="button"
                                                            class="btn btn-danger btn-sm remove-sub-head">Remove</button>
                                                    </div>
                                                </div>
                                            @endforeach
                                        </div>

                                        <button type="button" class="btn btn-secondary btn-sm mt-2 add-sub-head"
            ...
            <div class="card mt-3 rest-part">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-6">
                            <label class="form-label">{{ translate('FOB Port') }}</label>
                            <input type="text" class="form-control" name="fob_port"
                                placeholder="e.g., Shanghai, Ningbo" value="{{ $product->fob_port }}">
                        </div>
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <label class="form-label">{{ translate('HTS Code') }}</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" name="lead_time"
                                placeholder="e.g., 7-10 business days" value="{{ $product->lead_time }}">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">{{ translate('Dimensions per Unit') }}</label>
                            <input type="text" class="form-control" name="dimensions_per_unit"
                                placeholder="e.g., 10x5x2 cm" value="{{ $product->dimensions_per_unit }}">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" name="payment_terms"
                                ...
                                placeholder="e.g., T/T 30% deposit, 70% before shipment, Net 30/60, L/C at sight">
                        </div>
                        <div class="col-12">
    ...
    <span id="route-vendor-products-digital-variation-file-delete"
        data-url="{{ route('vendor.products.digital-variation-file-delete') }}"></span>
...
@push('script')
    ...
    <script>
        ...
        $('#add-title-group').click(function () {
            let titleIndexNew = {{ count($additionalDetails) ?? 0 }};

...
@section('title', translate($type == 'new-request' ? 'pending_products' : ($type == 'approved' ? 'approved_products' :
    'product_list')))
...
@section('content')
                                                    ...
                                                    @if (auth('admin')->check())
                                                        <form
                                                            ...
                                                            <button type="submit"
                                                                ...
                                                                onclick="return confirm('Are you sure you want to {{ $product['status'] == 1 ? 'revoke' : 'approve' }} this product?')">
                                                                <i
    ...
    <script>
        function sendtoSellOfferCreate(productId) {

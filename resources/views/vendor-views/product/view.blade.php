                    ...
                    <div class="media flex-nowrap flex-column flex-sm-row gap-3 flex-grow-1 align-items-center align-items-md-start">
                        ...
                        <div class="d-block flex-grow-1 w-max-md-100">
                            <div class="d-flex flex-wrap justify-content-between align-items-center">
                                ...
                                <div class="pb-4">
                                    <a href="{{ route('vendor.products.update', [$product['id']]) }}" class="btn btn-sm btn--primary">{{translate('Edit')}} <i class="tio-edit"></i> </a>
                                </div>
                            </div>
                    ...
                    <div class="row gy-3 flex-grow-1">
                        <div class="col-sm-6 col-xl-4">
                            ...
                            <div class="pair-list">
                                ...
                                <div>
                                    <span class="key text-nowrap">{{ translate('Badge') }}</span>
                                    <span>:</span>
                                    <span class="value">{{ $product->badge}}</span>
                                </div>
                                <div>
                                    <span class="key text-nowrap">{{ translate('Origin') }}</span>
                                    <span>:</span>
                                    <span class="value">{{ \App\Models\Country::where('id',$product->origin)->first()->name ?? 'Invalid Country ID' }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-6 col-xl-4">

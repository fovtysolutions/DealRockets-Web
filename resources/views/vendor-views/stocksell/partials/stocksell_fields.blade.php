            ...
            <div class="form-group">
                ...
                <div class="position-relative">
                    <input type="text" name="hs_code" id="hs_code" class="form-control"
                        value="{{ old('hs_code', $isEdit ? $stocksell->hs_code : '') }}" 
                        placeholder="Enter HS Code or Product Description" autocomplete="off" required>
...
$(document).ready(function() {
    ...
    // Use vendor stock route for stocksell forms
    const searchRoute = '{{ route("vendor.stock.search-hs-codes") }}';

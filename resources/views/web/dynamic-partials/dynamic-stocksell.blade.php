                        ...
                        <div class="product-info">
                            ...
                            <div class="product-rate">
                                ...
                                <div class="product-rate-value">
                                    {{ $stocksell->lower_limit ?? 'N/A' }}-{{ $stocksell->upper_limit ?? 'N/A' }}/{{ $stocksell->unit ?? 'N/A' }}
                                </div>
                            </div>
                            <div class="product-origin">
                                ...
                                <div class="product-origin-location">
                                    @php
                                        ...
                                        $imagepath = $countryISO2
                                            ? '/flags/' . strtolower($countryISO2) . '.svg'
                                            : null;
                                    @endphp
                                    ...
                                    @endif
                                    <div>{{ $stocksell->city ?? 'N/A' }},
                                        {{ \App\Models\Country::where('id', $stocksell->country)->first()->name }}</div>
                                </div>
                            </div>

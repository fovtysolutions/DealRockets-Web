        ...
        @else
            ...
            <ul class="nav nav-tabs" id="favTabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" style="color:black;" id="stocksell-tab" data-toggle="tab" href="#stocksell" role="tab">Stock
                        Sell</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" style="color:black;" id="buyleads-tab" data-toggle="tab" href="#buyleads" role="tab">Buy Leads</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" style="color:black;" id="saleoffer-tab" data-toggle="tab" href="#saleoffer" role="tab">Sale
                        Offer</a>
                </li>
            </ul>

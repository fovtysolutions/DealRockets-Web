...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    // Admin Suppliers
    Route::get(Supplier::ADD[URI], [SupplierController::class, 'add_new'])->name('add-new-suppliers');
    ...
    Route::post('tradeshow/delete' . '/{id}', [TradeshowController::class, 'delete'])->name('tradeshow.delete');

    // Category Management
    Route::prefix('tradeshow/category')->name('tradeshow.category.')->group(function () {
        Route::get('list', [TradeshowController::class, 'catindex'])->name('list');
        Route::get('create', [TradeshowController::class, 'catcreate'])->name('create');
        Route::post('store', [TradeshowController::class, 'catstore'])->name('store');
        Route::get('edit/{jobCategory}', [TradeshowController::class, 'catupdate'])->name('edit');
        Route::post('update/{jobCategory}', [TradeshowController::class, 'catupdate'])->name('update');
        Route::delete('delete/{jobCategory}', [TradeshowController::class, 'catdestroy'])->name('destroy');
    });
    ...
    Route::prefix('jobvacancy')->name('jobvacancy.')->group(function () {
        Route::get('list', [JobseekerController::class, 'adminindex'])->name('list');
        Route::get('add', [JobseekerController::class, 'create'])->name('create');
        Route::post('store', [JobseekerController::class, 'store'])->name('store');
        Route::get('edit/{id}', [JobseekerController::class, 'edit'])->name('edit');
        Route::post('update/{id}', [JobseekerController::class, 'update'])->name('update');
        Route::get('view/{id}', [JobseekerController::class, 'show'])->name('show');

...
Route::group(['middleware' => ['maintenance_mode']], function () {
    ...
    Route::group(['prefix' => 'vendor', 'as' => 'vendor.'], function () {
        ...
        Route::group(['prefix' => 'supplier', 'as' => 'supplier.'], function () {
            Route::get('status-update', [VendorSupplier::class, 'getIndex'])->name('status.update');
            Route::post('store',[VendorSupplier::class,'store'])->name('store');
            Route::post('update',[VendorSupplier::class,'update'])->name('update');
        });
        ...
        Route::group(['middleware' => ['seller']], function () {
            ...
            Route::prefix('stock')->name('stock.')->group(function () {
                Route::get('index',[VendorStockSellController::class,'index'])->name('index');
                Route::get('create',[VendorStockSellController::class,'create'])->name('create');
                Route::get('edit/{id}',[VendorStockSellController::class,'edit'])->name('edit');
                Route::get('show/{id}',[VendorStockSellController::class,'show'])->name('show');
                Route::post('store',[VendorStockSellController::class,'store'])->name('store');
